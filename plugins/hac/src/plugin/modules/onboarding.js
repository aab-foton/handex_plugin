...
const ONBOARDING_TOOLS = {
  especificar: {
    ...
    steps: [
      ...
      { text: 'No resumo da Detecção Automática, revise os grupos sugeridos e clique em <strong>Iniciar Revisão</strong> — cada item detectado abre para você confirmar, ajustar ou descartar antes de virar especificação. O paginador no topo do formulário mostra todos os itens da revisão: clique em qualquer número para pular direto para ele, em qualquer ordem — itens já documentados aparecem em verde e não podem ser confirmados de novo, descartados aparecem em cinza e continuam podendo ser reconsiderados. Se o hac sugeriu a categoria errada, use o ícone de lápis ao lado do título do formulário para trocar entre as 5 categorias sem perder o elemento selecionado. Textos sem nenhum token do DSC vinculado aparecem à parte, no bloco <strong>"Possíveis títulos sem token DSC"</strong> — vincule o Text Style no Figma e use o botão de <strong>Reescanear</strong> no topo do modal para atualizar sem perder o que já tinha revisado.' },
