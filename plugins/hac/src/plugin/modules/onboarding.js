...
const ONBOARDING_TOOLS = {
  web: {
    ...
    steps: [
      ...
      { text: 'Clique no card da tela para abrir o espaço de trabalho dela, organizado em abas: <strong>Tabulação</strong> (ordem de navegação por teclado), <strong>Leitor de Tela</strong> (as especificações de conteúdo/semântica) e <strong>Handoff de Acessibilidade</strong> (o painel de status que consolida tudo o que já foi documentado nessa tela, com o botão <strong>Gerar handoff completo</strong> para reinserir de uma vez só as seções pendentes ou desatualizadas). Web não tem a aba Ordem de Leitura: esse gesto é exclusivo de leitores de tela mobile.' },
