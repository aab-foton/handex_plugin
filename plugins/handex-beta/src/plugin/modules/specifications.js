...
// ============================================================
    ...
    // Botão "?" do cabeçalho abre o guia certo conforme a aba ativa —
    // guia de tipos de spec normal ou guia de categorias de acessibilidade.
    function openSpecsGuideHelp() {
      const panelA11y = document.getElementById('specs-panel-a11y');
      const isA11y = panelA11y && !panelA11y.classList.contains('hidden');
      if (isA11y && typeof openA11yCategoriesHelp === 'function') {
        openA11yCategoriesHelp();
        return;
      }
      openHelp();
    }
    window.openSpecsGuideHelp = openSpecsGuideHelp;
