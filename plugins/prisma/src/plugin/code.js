// ============================================================
// PRISMA — Plataforma de Revisão e Inspeção da Maturidade UX —
// code.js (main thread / Figma API)
...
const VERSION = typeof __PRISMA_VERSION__ !== 'undefined' ? __PRISMA_VERSION__ : '1.0.0';
const STORAGE_KEY = 'prisma-data';
