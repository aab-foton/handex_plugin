// ============================================================
// ai/foundry-client.js — Cliente do orquestrador de IA (PRISMA)
// ============================================================
//
// Esta é a camada de integração com o orquestrador de agentes de IA
// (Microsoft Foundry) que a Fóton está desenhando para o PRISMA.
...
module.exports = { analyzeWithFoundry, PRISMA_AI_DIMENSIONS };
